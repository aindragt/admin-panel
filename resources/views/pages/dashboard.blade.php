...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
        <div class="transform transition-all duration-200 hover:-translate-y-1">
            <x-ui.stat-card
                label="Total Users"
                value="1,284"
                change="+12.5%"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-6">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-5 transition-shadow hover:shadow-md">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <div class="flex items-center gap-2">
                        <h3 class="text-base font-semibold text-gray-900 dark:text-white">Revenue Overview</h3>
                        <span class="inline-flex items-center px-1.5 py-0.5 rounded-full text-[10px] font-medium bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-400">
        ...
        {{-- Donut Chart: 1 kolom --}}
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-5 transition-shadow hover:shadow-md">
            <div class="mb-4">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    ]; // Catatan: perbaikan array lookup di bawah menggunakan mapping langsung agar aman
                    ...
                    @php $cfg = $statusMap[$activity['status']]; @endphp
                    <tr class="hover:bg-indigo-50/40 dark:hover:bg-gray-800/60 transition-all duration-150">
                        {{-- User Info --}}
                        <td class="px-5 py-3.5">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-gradient-to-tr from-indigo-500 to-violet-500 flex items-center justify-center text-xs font-bold text-white shadow-sm flex-shrink-0">
        ...
        {{-- Table Footer --}}
        <div class="px-5 py-3 border-t border-gray-100 dark:border-gray-800 text-center bg-gray-50/30 dark:bg-gray-800/20">
